...
- **Far Lands** (Rare) — every joker in the shop and booster packs cycles between 2 jokers.
- **Herobrine** (Legendary) — every Mult bonus also applies to Chips and vice-versa; each round, a 1-in-3 chance to fire a random nasty effect.
- **Jockeyr** (Common) — +3 Mult per different rank and suit in the played hand.
- **\_jeb** (Uncommon) — Polychrome cards give an additional ×2 Mult.
...
> The old tool "jokers" (Stone Pickaxe, Iron Sword, Iron Shovel) are now implemented as **craftable consumables** — see [[Tools]].
